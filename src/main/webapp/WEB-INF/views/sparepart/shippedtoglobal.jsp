...
<body>
	...
	<div class="container">
		...
		<label for="myInput">Search the table:</label> <input type="text"
			id="myInput" onkeyup="searchTable()"
			placeholder="Type item to be found..."
			title="Type in searched phrase">
			...
			<tbody id="myTable">
				<c:forEach items="${shipmentsToGlobal}" var="shipment">
					<tr>
						...
						<td><c:out
								value="${shipment.sparePart.partCatalog.partNumber}" /></td>
						...
						<td>
							<div class="dropdown">
								<button type="button"
									class="btn btn-primary dropdown-toggle btn-secondary"
									data-toggle="dropdown">Actions</button>
								<div class="dropdown-menu">
									<a class="dropdown-item"
										href="${shipment.id}/shipments/editglobal">Edit</a> <a
										class="dropdown-item" href="${shipment.id}/shipments/cancel">Cancel</a>
									<sec:authorize access="hasRole('ADMIN')">
										<a class="dropdown-item"
											href="${shipment.id}/shipments/arrivedToGlobal">Mark as
											arrived</a>
									</sec:authorize>
								</div>
							</div>
